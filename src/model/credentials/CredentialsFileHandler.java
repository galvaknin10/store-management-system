...
public class CredentialsFileHandler {
    ...
    protected static void saveCredentialsToFile(Map<String, Credentials> credentials, String branch) {
        ...
        FileHandlerUtils.createJsonFile(credentials, fileName);
    }
    ...
    protected static Map<String, Credentials> loadCredentialsFromFile(String branch) {
        ...
        Map<String, Credentials> credentials = FileHandlerUtils.loadJsonFile(fileName, mapType);
    ...
    public static void createDefaultCredentialsRepo() {
        ...
        if (!FileHandlerUtils.fileExists("data/EILAT_credentials.json")) {
        ...
        if (!FileHandlerUtils.fileExists("data/JERUSALEM_credentials.json")) {
    ...
    private static void createDefaultRepo(String fileName, Map<String, Credentials> defaultData) {
        FileHandlerUtils.createJsonFile(defaultData, fileName);
    }
}
